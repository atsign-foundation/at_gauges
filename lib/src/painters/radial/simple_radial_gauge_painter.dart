...
class SimpleRadialGaugePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final startAngle = RadialHelper.degreesToRadians(-90);
    ...
    var strokeCapCircleOffset = Offset(
      (center.dx) +
          radius *
              cos(pi / 1.5 + sweepAngle + RadialHelper.degreesToRadians(150)),
      (center.dx) +
          radius *
              sin(pi / 1.5 + sweepAngle + RadialHelper.degreesToRadians(150)),
    );
