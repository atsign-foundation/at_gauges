...
import '../painters/radial/simple_radial_gauge_painter.dart';
                ...
                child: CustomPaint(
                  ...
                  child: Center(
                    child: ListTile(
                      title: widget.icon ??
                          Text(
                            '${RadialHelper.sweepAngleRadianToActualValue(sweepAngle: animationController.value, maxValue: widget.maxValue, minValue: widget.minValue).toStringAsFixed(widget.decimalPlaces)} ${widget.unit ?? ''} / ${widget.maxValue.toStringAsFixed(widget.decimalPlaces)} ${widget.unit ?? ''}',
